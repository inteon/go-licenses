...
func (l *Library) LicenseURL(ctx context.Context, cl *source.Client) (string, error) {
	if l == nil {
		return "", fmt.Errorf("library is nil")
	}
	filePath := l.LicenseFile
	...
	localContentBytes, err := os.ReadFile(l.LicenseFile)
	if err != nil {
